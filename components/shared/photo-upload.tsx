...
/** Optional photo attachment, used by Notes, Transactions (receipts), and Mileage entries
...
export function PhotoUpload({ photoUrls, onChange, label = "Photos (optional)" }: PhotoUploadProps) {
